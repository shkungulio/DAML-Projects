...
```{r}
heart_disease <- rpart(target ~ ., data = training.data, method = "class",
...
Option 1
```{r}
prp(heart_disease, faclen = 0, cex = 0.8, extra = 1)
```
...
prp(heart_disease, faclen = 0, cex = 0.8, node.fun = tot_count)
```
