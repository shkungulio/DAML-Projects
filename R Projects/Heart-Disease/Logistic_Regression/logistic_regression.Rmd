...
Cardiovascular disease remains the leading cause of mortality worldwide, placing a significant burden on individuals, healthcare systems, and economies. Early identification of individuals at high risk for heart disease is essential for timely intervention and effective clinical decision-making. As the demand for data-driven healthcare continues to grow, predictive modeling plays an increasingly important role in supporting diagnosis and treatment pathways.

The UCI Heart Disease dataset is a widely recognized collection of patient data aimed at predicting the presence or absence of heart disease based on various clinical and demographic variables. The dataset contains multiple features such as age, sex, blood pressure, cholesterol levels, maximum heart rate, and other indicators collected from medical examinations.

This project explores the use of **logistic regression** to develop a predictive model for heart disease classification. Logistic regression is particularly suitable for binary classification problems, such as distinguishing between the presence or absence of a medical condition. The goal is to derive insights from the model that could potentially support clinicians in identifying at-risk individuals with greater confidence and accuracy.

As a healthcare professional working in a cardiovascular unit, I have firsthand experience witnessing the impact of heart disease on patient outcomes. Integrating statistical modeling into clinical workflows holds promise for improving patient care, and this project aims to bridge practical healthcare knowledge with analytical techniques.    
<br>
...
### **Problem Statement**
Heart disease diagnosis often requires a combination of clinical judgment and diagnostic tests, which may not always be readily accessible or conclusive. Therefore, the ability to predict the likelihood of heart disease using easily obtainable patient data can assist healthcare professionals in prioritizing care and initiating early interventions.

This project seeks to answer the following question:

> **Can we build a logistic regression model that accurately predicts the presence of heart disease based on clinical and demographic attributes in the UCI dataset?**

To address this, we will:
- Clean and preprocess the dataset.
- Explore variable relationships through statistical summaries and visualizations.
- Train a logistic regression model using key predictors.
- Evaluate the model's performance using accuracy, sensitivity, specificity, and AUC-ROC metrics.
- Interpret the significance of predictors to inform potential clinical relevance.

By leveraging logistic regression, this study aims to provide a simple yet interpretable model that can support healthcare providers in risk stratification and decision-making processes.  
<br>
